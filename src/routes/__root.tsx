...
function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div
        className="relative flex h-12 w-12 items-center justify-center rounded-full shadow-elevated transition-transform duration-300 hover:scale-110 active:scale-95"
...
function ScrollToTopButton() {
  ...
  return (
    <button
      ...
      className={`flex h-12 w-12 items-center justify-center rounded-full border border-border bg-white/95 text-foreground shadow-elevated backdrop-blur transition-all duration-300 hover:scale-110 hover:shadow-lg active:scale-95 ${
